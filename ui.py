...
def create_window():
    ...
    icon_path = os.path.join(os.path.dirname(__file__), "cards/ace_of_hearts.ico")

    try:
    	root.iconbitmap(icon_path)
    except Exception as e:
    	print("⚠️ Could not load icon:", e) #ace_of_hearts.ico error
					   #perm fix //  loads game without crashing sends
					   #sends crash report
